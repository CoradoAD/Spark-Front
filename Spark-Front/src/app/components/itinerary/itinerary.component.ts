...
export class ItineraryComponent implements OnInit {
  ...
  constructor( private mapServ: MapService ,private itineraryServ: ItineraryService) {
    ...
    if(navigator.geolocation){
      ...
      navigator.geolocation.getCurrentPosition((position)=>{
        ...
        console.log("END COORDONNEES!!");
         this.itineraryServ.navGPS.localLat = position.coords.latitude;
         this.itineraryServ.navGPS.localLon = position.coords.longitude;
       });
     }
      else{
    ...
    this.itineraryServ.setRouting(this.navGPS);
